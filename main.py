...
app = FastAPI(title="MaxShop V7.6")
...
def serve():
    for ruta in POSIBLES_RUTAS:
        try:
            ...
            continue
    return HTMLResponse("""
    <html><body style="font-family:sans-serif;padding:20px;background:#f6f5ff">
    <h1>MaxShop V7.6</h1>
    <p>Subi index.html en la RAIZ del repo, al lado de main.py (no dentro de templates).</p>
    <p><a href="/docs">Docs</a> | <a href="/api">API</a></p>
    </body></html>
    """)

@app.get("/api")
def api():
    return {"msg": "MaxShop V7.6 - Drive publico", "comision": "1.7%", "csb": "10% / 5%", "ley": "25.326"}
